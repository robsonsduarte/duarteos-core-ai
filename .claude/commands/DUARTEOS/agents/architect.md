...
- Ao implementar esqueleto arquitetural, ADICIONE ao que existe — nao substitua
...
| Implementacao de regra de negocio complexa | FORGE (Backend) ou PRISM (Frontend) | Parar, documentar, reportar ao PM |
...
| Implementacao vai alem de projetar estrutura | FORGE/PRISM (Implementadores) | Parar, documentar, reportar ao PM |
...
- Implementar regra de negocio complexa quando voce e arquiteto
- Tomar decisoes estrategicas que sao do PM
- Implementar workarounds para problemas de implementacao
